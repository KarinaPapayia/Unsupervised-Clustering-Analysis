...
class ClusterAssignment(nn.Module):
    def __init__(self,
        ...
        """
        Module to handle the soft assignment, where the Student's t-distribution is used measure similarity between feature vector and each cluster centroid.
        #Arguments:
    ...
    def forward(self, batch: torch.Tensor) -> torch.Tensor:
        ...
        #Arguments:
        batch: FloatTensor of [batch size, embedding dimension] (size of batch in the embedding dimension)
