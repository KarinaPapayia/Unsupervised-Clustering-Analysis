...
from lib.dae import DenoisingAutoencoder
...
def pretrain(dataset,
    ...
    #Arguments:
        ...
        autoencoder: instance of an autoencoder to train
        epochs: number of training epochs
        batch_size: batch size for training
        corruption: proportion of masking corruption to apply, set to None to disable, defaults to None
        optimizer: function taking model and returning optimizer
        scheduler: function taking optimizer and returning scheduler, or None to disable
        validation: instance of Dataset to use for validation
        cuda: whether CUDA is used, defaults to True
        sampler: sampler to use in the DataLoader, defaults to None
        silent: set to True to prevent printing out summary statistics, defaults to False
        update_freq: frequency of batches with which to update counter, None disables, default 1
        update_callback: function of loss and validation loss to update
        num_workers: optional number of workers to use for data loading
        epoch_callback: function of epoch and model
    #Return:
      None
    """
